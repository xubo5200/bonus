...
[task_local]
#蝉妈妈(自己改五分钟一次)
10 0-23 * * * https://raw.githubusercontent.com/xubo5200/bonus/master/qlp.js, tag=蝉妈妈, img-url=https://ae01.alicdn.com/kf/Uc2775b8f4abf41788ba89df0317e58050.jpg, enabled=true
...
async function landmsg() {
    return new Promise((resolve) => {
        let landmsg_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/message`,
...
async function unlock() {
    return new Promise((resolve) => {
        let unlock_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/unlock`,
            headers: JSON.parse(cmmheader),
...
async function room() {
    return new Promise((resolve) => {
        let room_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/order/msg`,
            headers: JSON.parse(cmmheader)
        }
...
async function submit() {
    return new Promise((resolve) => {
        let submit_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/order/reward`,
            headers: JSON.parse(cmmheader)
        }
...
async function list() {
    return new Promise((resolve) => {
        let list_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/order/exchange/list`,
            headers: JSON.parse(cmmheader)
        }
...
async function plant0() {
    return new Promise((resolve) => {
        let plant0_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/plant`,
            headers: JSON.parse(cmmheader),
...
async function havest() {
    return new Promise((resolve) => {
        let havest_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/harvest`,
            headers: JSON.parse(cmmheader),
            body: `{"landIndex":${no}}`
        }
...
async function lookVideo() {
    return new Promise((resolve) => {
        let lookVideo_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/ad/lookVideo`,
            headers: JSON.parse(cmmadheader),
            body: cmmadbody
        }
...
async function cloud() {
    return new Promise((resolve) => {
        let cloud_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/cloud/used`,
            headers: JSON.parse(cmmheader),
            body: `null`
        }
...
async function rewardlist() {
    return new Promise((resolve) => {
        let rewardlist_url = {
            url: `https://bp-api.coohua.com/bubuduo-cmm/game/sign/reward/list`,
            headers: JSON.parse(cmmheader),
        }
