...
const headers = {
    "lo": "110.3211959246934",
    "apiVersion": "2.0",
    "content-type": "application/json",
    "anonymousId": "",
    "channel": "big_frontend_hyg_weapp",
    "warehouseId": "10",
    "nativeVersion": "10.10.72",
    "subsiteId": "10",
    "openid": "oKweD5Y1bcoe-PmkaDeg3pO49XEw",
    "Appkey": "850226",
    "userId": "7773827927444684802",
    "unique": "weapp-2025030314421862702118705452928115740",
    "usersession": "",
    "token": $.getdata("cdf_hainan"),
    "appVersion": "10.10.74",
    "fpp": "efb6a8cdf054813edcfbff7108acf716-1741878745045",
    "Accept": "application/json, text/plain, */*",
    "la": "19.89132072995906",
    ...
    "Referer": "https://servicewechat.com/wx83f3046fd293eefa/269/page-frame.html",
};
// 主函数
(async () => {

    let q = Date.now()
    let fpp = [md5("cdfhnms500".concat(q)), q].join("-").toLowerCase()
    headers.fpp = fpp


    await new Promise(resolve => {
        const options = {
            url: 'https://weapp.cdfgsanya.com/api/overseas/topic/coupon/take?id=2bbe2f8085ba090a&idCardNo=',
            headers: headers
        }
